...
const i18n = {
  en: {
    ...
    'morebuilds.kicker': 'more builds',
    'morebuilds.title': 'More systems shipped end to end.',
    'morebuilds.copy': 'Six more products across web, mobile, and desktop — each one built, deployed, and used for a real workflow.',
  ...
  ar: {
    ...
    'morebuilds.kicker': 'مشاريع تانية',
    'morebuilds.title': 'أنظمة تانية اتبنت وخلصت من أول لآخر.',
    'morebuilds.copy': 'ستة منتجات تانية بين ويب وموبايل ودسكتوب — كل واحد اتبنى، اتنشر، وبيتستخدم في شغل حقيقي.',
